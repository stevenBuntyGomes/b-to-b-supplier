...
const TaxInvoice = () => {
  return (
    <Fragment>
            <Breadcrumbs parent={`${API_ENDPOINT}/app/ecommerce/pi/create/Dubai`} title="Manage Invoices" mainTitle="Manage Invoices" />
            <Container fluid={true}>
                <Row>
                    <Col sm="12">
                        <Card>
                            <HeaderCard title='List of Invoice created' span1='List of Invoice created' />
                            <CardHeader className='mt-0'>
                                <Btn link = {`${API_ENDPOINT}/app/ecommerce/create-tax-invoice/Dubai`} attrBtn={{ color: "dark", className: "m-r-15", type: "submit" }} >
