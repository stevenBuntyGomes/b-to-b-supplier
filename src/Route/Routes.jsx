...
// RFQ
// create quote
import CreateQuote from '../Components/Application/Ecommerce/CreateQuote'; 
import PurchaseOrder from '../Components/Application/Ecommerce/PurchaseOrder';
// create quote
...
import ReadyToSellSupplier from '../Components/Application/Ecommerce/Supplier/ReadyToSellSupplier';
import RfqReceivedSup from '../Components/Application/Ecommerce/Supplier/RfqReceivedSup';
import QuoteSentSup from '../Components/Application/Ecommerce/Supplier/QuoteSentSup';
// Supplier part ends
// buyer part starts
import NewBuyerList from '../Components/Application/Ecommerce/Buyer/NewBuyerList';
import ExistingBuyerList from '../Components/Application/Ecommerce/Buyer/ExistingBuyerList';
import RfqCreated from '../Components/Application/Ecommerce/Buyer/RfqCreated';
import ReadyToBuy from '../Components/Application/Ecommerce/Buyer/ReadyToBuy';
import QuoteReceived from '../Components/Application/Ecommerce/Buyer/QuoteReceived';
import GroupBuying from '../Components/Application/Ecommerce/Buyer/GroupBuying';
// buyer part ends
// tech support starts
...
// tech support ends
// settings part
import Settings from '../Components/Application/Ecommerce/Settings/AccountSettings';
// settings part
// supplier payment part
import SupplierInvoice from '../Components/Application/Ecommerce/SupplierPayments/Invoice';
import DebitCreditNote from '../Components/Application/Ecommerce/SupplierPayments/DebitCreditNote';
import DueForPayment from '../Components/Application/Ecommerce/SupplierPayments/DueForPayment';
// supplier payment part
// customer invoice
import CustomerInvoice from '../Components/Application/Ecommerce/CustomerPayment/Invoice';
import CustomerDebitCreditNote from '../Components/Application/Ecommerce/CustomerPayment/DebitCreditNote';
import CustomerDueForPayment from '../Components/Application/Ecommerce/CustomerPayment/DueForPayment'; 
// customer invoice
// product sample
import ProductSample from '../Components/Application/Ecommerce/ProductSample/ProductSample';
// product sample
...
import ProjectAwarded from '../Components/Application/Ecommerce/ManageProject/ProjectAwarded';
import OnGoingProject from '../Components/Application/Ecommerce/ManageProject/OnGoingProject';
...
export const routes = [
  ...
  // rfq
  // create quote
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/create-quote/:layout`, Component: <CreateQuote /> },
  // create quote
  // purchase order
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/purchase-order/:layout`, Component: <PurchaseOrder /> },
  // purchase order
  // manage project
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/project-awarded/:layout`, Component: <ProjectAwarded /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/on-going-project/:layout`, Component: <OnGoingProject /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/canceled-project/:layout`, Component: <CenceledProject /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/project-status/:layout`, Component: <ProjectStatus /> },
  // manage project
  // payment starts
  ...
  // payment ends
  // shipping documents
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/packaging-list/:layout`, Component: <PackagingList /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/po/:layout`, Component: <PO /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/coo/:layout`, Component: <COO /> },
  // shipping documents
  // pk list main
  ...
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/ready-to-sell/:layout`, Component: <ReadyToSellSupplier /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/rfq-received-supplier/:layout`, Component: <RfqReceivedSup /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/quote-sent-supplier/:layout`, Component: <QuoteSentSup /> },
  // supplier routes ends
  // buyer route starts
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/new-buyer/:layout`, Component: <NewBuyerList /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/existing-buyer/:layout`, Component: <ExistingBuyerList /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/ready-to-buy/:layout`, Component: <ReadyToBuy /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/rfq-created-buyer/:layout`, Component: <RfqCreated /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/quote-received-buyer/:layout`, Component: <QuoteReceived /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/group-buying/:layout`, Component: <GroupBuying /> },
  // buyer route ends
  // tech support starts
  ...
  // tech support ends
  // supplier payment part starts
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/supplier-payment/:layout`, Component: <SupplierInvoice /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/debit-credit-payment/:layout`, Component: <DebitCreditNote /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/due-for-payment/:layout`, Component: <DueForPayment /> },
  // supplier payment part ends
  // customer payment part starts
  


  { path: `${process.env.PUBLIC_URL}/app/ecommerce/customer-payment/:layout`, Component: <CustomerInvoice /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/debit-credit-payment-customer/:layout`, Component: <CustomerDebitCreditNote /> },
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/due-for-payment-customer/:layout`, Component: <CustomerDueForPayment /> },
  // customer payment part ends
  // settings part starts
  // ProductSample
  { path: `${process.env.PUBLIC_URL}/app/ecommerce/product-sample/:layout`, Component: <ProductSample /> },
  // ProductSample
  // feedback part
